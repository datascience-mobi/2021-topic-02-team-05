...
```{r heatmap, eval=FALSE, include=FALSE, fig.cap= "Heatmap of  our genes of interest. This heatmap illustrates the gene expression of the thyroid specific antigens in our matrix."}
