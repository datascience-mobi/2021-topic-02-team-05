...
#the first 6 TSG and their expression levels in cancer tissue exposed to radiation, sporadic cancer tissue and healthy tissue
```
...
# when the difference in gene expression for gene i between two groups is higher than 5%, the corresponding gene name (=> colnames(anovamatrix)[i]) is added in the vector sig.genes.vector. 
